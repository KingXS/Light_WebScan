...
# Form implementation generated from reading ui file 'LD-cms.ui'
#
...
class Ui_LD_cms(object):
    def setupUi(self, LD_cms):
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 100, 72, 15))
        self.label_2.setObjectName("label_2")
        self.lineEdit = QtWidgets.QLineEdit(LD_cms)
        self.lineEdit.setGeometry(QtCore.QRect(210, 90, 331, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton = QtWidgets.QPushButton(LD_cms)
        self.pushButton.setGeometry(QtCore.QRect(590, 90, 93, 28))
        self.pushButton.setObjectName("pushButton")
        self.textEdit = QtWidgets.QTextEdit(LD_cms)
        self.textEdit.setGeometry(QtCore.QRect(120, 150, 521, 241))
